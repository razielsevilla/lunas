    ...
    <PatientLayout activePath="/profile">
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        <div className="space-y-6">
          ...
          {/* 1. Basic Medical Information Section */}
          ...
          <div className="rounded-[2.5rem] border border-neutral-200 bg-white p-8 shadow-sm">
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={i} className="flex flex-wrap items-end gap-4 rounded-[1.5rem] border border-neutral-100 bg-[#fbf8f2]/50 p-5">
          ...
          {/* 3. Medications Section with Interaction Alert */}
          <div className="rounded-[2.5rem] border border-neutral-200 bg-white p-8 shadow-sm">
            <div className="flex items-center justify-between border-b border-neutral-100 pb-6">
            ...
            <div className="mt-8 space-y-6">
              {[
                ...
                <div key={i} className="flex flex-wrap items-end gap-4 rounded-[1.5rem] border border-neutral-100 bg-[#fbf8f2]/50 p-5">
                  <div className="flex-1 space-y-2 min-w-[200px]">
                    ...
                    <input type="text" defaultValue={med.name} className="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm outline-none" />
                  </div>
                  <div className="flex-1 space-y-2 min-w-[200px]">
                    <label className="text-[9px] font-bold uppercase tracking-widest text-[#8d8374]">Dosage</label>
                    <input type="text" defaultValue={med.dose} className="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm outline-none" />
                  </div>
                  <div className="flex-1 space-y-2 min-w-[200px]">
                    <label className="text-[9px] font-bold uppercase tracking-widest text-[#8d8374]">Frequency</label>
                    <input type="text" defaultValue={med.freq} className="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm outline-none" />
                  </div>
                  <button className="flex h-11 w-11 items-center justify-center rounded-xl text-neutral-400 hover:bg-red-50 hover:text-red-500">
                    <Trash2 className="h-4 w-4" />
                  </button>
              ...
              {/* Interaction Alert — Matches Screenshot 191046 */}
          ...
          {/* 4. Emergency Contacts — Matches Screenshot 191058 */}
          <div className="rounded-[2.5rem] border border-neutral-200 bg-white p-8 shadow-sm">
            <div className="flex items-center justify-between border-b border-neutral-100 pb-6">
          ...
          {/* 5. Additional Notes — Matches Screenshot 191116 */}
          <div className="rounded-[2.5rem] border border-neutral-200 bg-white p-8 shadow-sm">
             <div className="flex items-center justify-between border-b border-neutral-100 pb-6">
